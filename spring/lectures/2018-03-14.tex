...
& \v q = \v q_{\text{одн}} + \sum_{k = 0}^{+\infty}\v q\text{ч}^{(k)} &\\
...
& x\text{ч} = R\sin(\omega t + \varphi) &\\
& \dot x\text{ч} = R\omega\sin(\omega t + \varphi) &\\
& \ddot x\text{ч} = - R\omega^2\sin(\omega t + \varphi) &\\
...
& \v q = \v q\text{ч} = \v h e^{i\omega t} \quad \dv q = \v h i \omega e^{i \omega t} \quad \ddot{\v q} = \v h(i\omega)^2 e^{i\omega t} &\\
